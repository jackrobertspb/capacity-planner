...
class ProjectAllocationController extends Controller
{
    ...
    public function update(Request $request, ProjectAllocation $projectAllocation)
    {
        ...
        if (isset($validated['start_date']) || isset($validated['end_date'])) {
            $startDate = $validated['start_date'] ?? $projectAllocation->start_date->toDateString();
            $endDate = $validated['end_date'] ?? $projectAllocation->end_date->toDateString();
        ...
        return response()->json([
            'allocation' => [
                ...
                'start_date' => $projectAllocation->start_date->toDateString(),
                'end_date' => $projectAllocation->end_date->toDateString(),
