                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        name="name"
                                        value={data.name}
                                        className="w-full pl-11 pr-4 py-3 border-2 border-emerald-600/40 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-emerald-500 transition-all bg-background"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        name="password"
                                        value={data.password}
                                        className="w-full pl-11 pr-12 py-3 border-2 border-emerald-600/40 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-emerald-500 transition-all bg-background"
