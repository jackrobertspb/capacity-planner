                        ...
                        <form onSubmit={submit}>
                            <div>
                                ...
                                <input
                                    ...
                                    name="email"
                                    value={data.email}
                                    className="w-full px-3 py-2 border border-emerald-600/40 rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-emerald-500 bg-muted"
                            ...
                            <div className="mt-4">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        name="password"
                                        value={data.password}
                                        className="w-full px-3 py-2 border border-emerald-600/40 rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-emerald-500 pr-10"
