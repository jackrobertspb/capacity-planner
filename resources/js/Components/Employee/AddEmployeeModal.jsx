                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3">
                            <input
                                ...
                                required
                                className="w-32 px-3 py-2 bg-background border border-border rounded-md text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
                            />
                    ...
                    <div className="flex items-center gap-3 pt-2">
                        <button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                                formData.can_access_workspace ? 'bg-green-500' : 'bg-muted'
                            }`}
                        >
                            <span
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <select
                                    ...
                                    className="text-sm px-3 py-1.5 bg-background border border-border rounded-md text-foreground cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary"
                                >
                    ...
                    <div className="flex items-center gap-3 pt-4">
                        <button
                            type="submit"
                            disabled={processing}
                            className="px-4 py-2 text-sm font-medium bg-muted hover:bg-muted/80 text-foreground rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
