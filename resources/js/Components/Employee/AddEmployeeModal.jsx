                    ...
                    <div className="p-6 space-y-4">
                        ...
                        <div className="flex gap-2">
                            <input
                                value={invitationUrl || ''}
                                readOnly
                                className="flex-1 px-3 py-2 bg-background border border-emerald-600/40 rounded-md text-foreground font-mono text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                            />
                            <button
                                type="button"
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                            className="w-full px-3 py-2 bg-background border border-emerald-600/40 rounded-md text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-emerald-500"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3">
                            <input
                                ...
                                required
                                className="w-32 px-3 py-2 bg-background border border-emerald-600/40 rounded-md text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-emerald-500"
                            />
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <select
                                    ...
                                    className="text-sm px-3 py-1.5 bg-background border border-emerald-600/40 rounded-md text-foreground cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:border-emerald-500"
                                >
