...
import { Edit2, Trash2, Plus, Umbrella, MapPin } from 'lucide-react';
        ...
        >
            <div className="flex flex-col gap-0.5 h-full">
                ...
                {leave.map((l) => (
                    <div
                        key={l.id}
                        className="text-xs px-2 py-1 rounded-md truncate bg-orange-500 text-white font-medium shadow-sm flex items-center gap-1"
                ...
                {markers.map((marker) => (
                    <div
                        key={marker.id}
                        className="text-xs px-2 py-1 rounded-md truncate border-2 border-dashed relative group cursor-pointer font-medium transition-all hover:border-solid flex items-center gap-1"
                        style={{
